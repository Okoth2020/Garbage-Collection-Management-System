...
if (isset($_POST["take_action"])) {
    ...
    if ($remark == "") {
        ...
        $sql = "INSERT INTO request_actions (
            ...
            request_id,
            agent
        ) VALUES ('$remark', '$assign_to', '$assign_date', '$status', '$request_username', '$request_number','admin')";
        ...
        if ($updated) {
            header("Location: ../notifications.php?to=user&person=" . $request_username . "&message=" . $remark . "&category=actions&redirect=user/requests.php?id=" . $user_id);
        } else {
